      ...
      <div className="grid two">
        <div className="card">
          ...
          <select id="scope" value={scope} onChange={(event) => setScope(event.target.value)}>
            <option value="MEDICAL_RECORD">授權驗證（vc_cond + vc_cons1）</option>
            <option value="MEDICATION_PICKUP">領藥驗證（vc_rx1 + vc_algy）</option>
            <option value="RESEARCH_ANALYTICS">研究揭露（vc_cond + vc_cons1 + vc_algy）</option>
          </select>
